...
const styles = StyleSheet.create({
  ...
  scoreValue: { fontSize: 28, fontWeight: "bold", color: "#2563EB" },
  ...
  qaQuestion: { fontSize: 10, fontWeight: "bold", marginBottom: 3, color: "#111827" },
  qaFeedback: { fontSize: 9, marginBottom: 4, color: "#4B5563" },
  qaAnswer: { fontSize: 8, color: "#6B7280", fontStyle: "italic", marginTop: 2 },
  scoreBadge: {
    fontSize: 9,
    fontWeight: "bold",
    color: "#2563EB",

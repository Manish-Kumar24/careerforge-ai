...
export default function InterviewReport() {
  ...
  const [error, setError] = useState<string | null>(null); // ✅ FIX: Define setError
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <div className="space-y-4">
          <div className="p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
            <div className="flex items-center justify-between">
              ...
              {/* ✅ POLISH: Show hint count if available */}
        ...
        <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4 bg-white dark:bg-gray-900">
          ...
          <div className="space-y-3 max-h-[50vh] overflow-y-auto pr-2">
            {/* Replace the perQuestionFeedback map with this */}
            {report.perQuestionFeedback.map((q) => (
              <div key={q.questionIndex} className="p-3 border border-gray-200 dark:border-gray-700 rounded-lg text-sm">
                <div className="flex items-start justify-between gap-2">
                  ...
                  {/* ✅ POLISH: Show "No answer" badge if empty */}
                  {q.didNotAnswer && (
                ...
                {/* ✅ POLISH: Show original answer with preserved formatting */}
          ...
          {/* ✅ FIX: Simple backend PDF download button */}
            ...
            <button
              onClick={async () => {
                ...
                try {
                  ...
                  const response = await fetch(`/api/mock-interview/session/${sessionId}/report/pdf`, {

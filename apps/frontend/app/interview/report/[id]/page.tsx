...
// ✅ Dynamic import for client-side PDF generation (SSR incompatible)
const PDFDownloadLink = dynamic(
  () => import("@react-pdf/renderer").then((mod) => mod.PDFDownloadLink),
  { ssr: false, loading: () => <span className="text-sm text-gray-500">Preparing PDF...</span> }
);

// ✅ Dynamic import for PDF document component
    ...
    <div className="max-w-5xl mx-auto p-6">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4 bg-white dark:bg-gray-900">
          ...
          {/* ✅ FIX: Client-side PDF download button using @react-pdf/renderer */}
